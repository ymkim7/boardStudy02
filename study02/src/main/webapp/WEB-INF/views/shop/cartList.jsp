				...
				<section id="content">
					<ul>
						...
						<c:forEach items="${cartList }" var="cartList">
							<li>
								<div class="checkBox">
									<input type="checkbox" class="chBox" name="chBox" data-cartNum="${cartList.cartNum }"/>
								
									<script type="text/javascript">
										$(".bhBox").click(function(){
								...
								<div class="gdsInfo">
									<p>
										...
										<span>개당가격</span><fmt:formatNumber pattern="###,###,###" value="${cartList.gdsPrice }"></fmt:formatNumber><br/>
										<span>구입수량</span>${cartList.cartStock }<br/>
										<span>최종가격</span><fmt:formatNumber pattern="###,###,###" value="${cartList.gdsPrice * cartList.cartStock }"></fmt:formatNumber>
									</p>
					...
					<div class="listResult">
						<div class="sum">
							총 합계 : <fmt:formatNumber pattern="###,###,###" value="${sum }"></fmt:formatNumber>원
						</div>
						<div class="orderOpne'">
					...
					<div class="orderInfo">
						<form role="form" method="post" autocomplete="off">
							...
							<div class="inputArea">
								...
								<button type="button" class="cancle_bnt">취소</button>
								
								<script type="text/javascript">
									$(".cancle_bnt").click(function(){
										$(".orderInfo").slideUp();
